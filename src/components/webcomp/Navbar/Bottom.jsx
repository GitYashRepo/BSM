                  ...
                  <div className="grid grid-cols-12 gap-8">
                     ...
                     <div className="col-span-4">
                        <div className="bg-secondary/50 rounded-xl p-6">
                           <div className="flex items-center gap-2 mb-3">
                              <Sparkles className="w-5 h-5 text-[#750851]" />
                              <h4 className="font-display font-semibold text-[#750851]">{item.featured.title}</h4>
                           </div>
                     ...
                     <div className="col-span-4">
                        <div className="bg-muted rounded-xl p-6">
                           <h4 className="font-display font-semibold text-[#750851] mb-4">Quick Contact</h4>
                           ...
                           <ul className="space-y-3 text-sm">
                              ...
                              <li className="flex items-center gap-3 text-foreground">
                                 <Mail className="w-4 h-4 text-[#750851]" />
                                 <span>sakshimakeovers@gmail.com</span>
                              </li>
                              <li className="flex items-center gap-3 text-foreground">
                                 <Clock className="w-4 h-4 text-[#750851]" />
